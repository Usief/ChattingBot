...
class Seq2SeqModel():
    ...
    def __init__(self, source_vocab_size, target_vocab_size, en_de_seq_len, hidden_size, num_layers,
        ...
        :param en_de_seq_len: source和target端序列的最大长度
        :param hidden_size: RNN模型的隐藏单元个数
        :param num_layers: RNN堆叠层数
        :param batch_size: batch大小
        :param learning_rate: 学习率
        :param num_samples: 计算loss时做sampled softmax时的采样数
        :param forward_only: 预测模型的开关
        :param beam_search: 使用哪种模型进行预测，greedy search还是beam search
